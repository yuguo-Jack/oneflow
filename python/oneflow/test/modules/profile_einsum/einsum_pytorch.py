...
# pytorch
input_tensors = [torch.rand(*shape, device="cuda") for shape in input_shapes]
...
pytorch_time_per_run_ms = total_time_ms / args.run_iters
print(
    f"pytorch avg time per iter: {pytorch_time_per_run_ms:.2f} ms (= {total_time_ms:.1f}ms / {args.run_iters})"
)
