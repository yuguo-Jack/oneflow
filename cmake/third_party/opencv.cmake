...
if(WIN32)
    ...
    set(OPENCV_BUILD_3RDPARTY_LIBRARY_DIR ${OPENCV_INSTALL_DIR}/staticlib)
    set(OPENCV_LIBRARY_NAMES opencv_core331d.lib opencv_imgcodecs331d.lib opencv_imgproc331d.lib)
    set(OPENCV_3RDPARTY_LIBRARY_NAMES IlmImfd.lib libjasperd.lib libpngd.lib libtiffd.lib libwebpd.lib)

    message(STATUS "opencv++++++++++++++++ ${OPENCV_LIBRARY_DIR}")
    message(STATUS "opencv++++++++++++++++ ${OPENCV_BUILD_LIBRARY_DIR}")

    foreach(LIBRARY_NAME ${OPENCV_LIBRARY_NAMES})
        list(APPEND OPENCV_STATIC_LIBRARIES ${OPENCV_LIBRARY_DIR}/${LIBRARY_NAME})
        list(APPEND OPENCV_BUILD_STATIC_LIBRARIES ${OPENCV_INSTALL_DIR}/staticlib/${LIBRARY_NAME})
    endforeach()
