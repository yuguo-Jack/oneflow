...
if(BUILD_PYTHON)
  ...
  message(STATUS "UUUUUUUU ${PYBIND11_SRCS}\n\n ${of_pybind_obj_cc}\n\n ${PYBIND_REGISTRY_CC}")
...
if(BUILD_PYTHON)
  ...
  foreach(of_include_src_dir ${CFG_INCLUDE_DIR})
    message(STATUS "include dir: ${CFG_INCLUDE_DIR}")
    message(STATUS "include dir: ${of_include_src_dir}")
    message(STATUS "include dir: ${of_include_copy}")
    string(REPLACE "\\" "/" CFG_INCLUDE_DIR ${CFG_INCLUDE_DIR})
    string(REPLACE "\\" "/" of_include_src_dir ${of_include_src_dir})
    # string(REPLACE "\\" "/" of_include_copy ${of_include_copy})
