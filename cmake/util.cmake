...
function(add_copy_headers_target)
  ...
  message(STATUS "XXXXXX: name ${PARSED_ARGS_NAME} src ${PARSED_ARGS_SRC} dst ${PARSED_ARGS_DST}")
...
function(use_mirror)
  ...
  set(UTIL_PYTHON_EXECUTABLE "python3.exe" CACHE STRING "Python executable to run util")
  # TODO: windows shall find a way to detect python.exe | python version
  ...
  if(DEFINED THIRD_PARTY_MIRROR)
    if(THIRD_PARTY_MIRROR STREQUAL "aliyun")
      ...
      if (NOT (ret_code EQUAL "0"))
        message(FATAL_ERROR "++++++${UTIL_PYTHON_EXECUTABLE} ${ret_code}++++++")
