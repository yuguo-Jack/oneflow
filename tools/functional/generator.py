...
types_allowed = {
    ...
    "IntList",
    "Int32List",
    "Int32ListPoolAllocator",
    "Int64List",
    "Int64ListPoolAllocator",
    "FloatList",
    "DoubleList",
    "StringList",
    "BoolList",
...
mangled_name = {
    ...
    "IntList": "Il",
    "Int32List": "I32l",
    "Int32ListPoolAllocator": "I32lp",
    "Int64List": "I64l",
    "Int64ListPoolAllocator": "I64lp",
    "FloatList": "Fl",
    "DoubleList": "Dl",
    "StringList": "Sl",
    "BoolList": "Bl",
...
argument_type_aliases = {
    ...
    "Int32ListPoolAllocator": "const std::vector<int32_t, __gnu_cxx::__pool_alloc<int32_t>>&",
    "Int64List": "const std::vector<int64_t>&",
    "Int64ListPoolAllocator": "const std::vector<int64_t, __gnu_cxx::__pool_alloc<int64_t>>&",
...
optional_argument_type_aliases = {
    ...
    "Int32ListPoolAllocator": "const Optional<std::vector<int32_t, __gnu_cxx::__pool_alloc<int32_t>>>&",
    "Int64List": "const Optional<std::vector<int64_t>>&",
    "Int64ListPoolAllocator": "const Optional<std::vector<int64_t, __gnu_cxx::__pool_alloc<int64_t>>>&",
